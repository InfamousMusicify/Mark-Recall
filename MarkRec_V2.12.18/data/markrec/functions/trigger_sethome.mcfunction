...
execute at @s[scores={mark=1..,mark_track=0,mark_crouch=0}] store result score @e[sort=nearest,limit=1,distance=1..8] mark_tag_along run scoreboard players get @s markrec_id
